...
public static class ThemePalette
{
    public static void Apply(ResourceDictionary resources, string theme)
    {
        if (ShouldUseDarkTheme(theme))
        {
            ...
            SetBrush(resources, "AppResultsBrush", "#1D2124");
            SetBrush(resources, "AppSearchInputBrush", "#151515");
            SetBrush(resources, "AppSearchInputBorderBrush", "#797979");
            ...
            SetBrush(resources, "AppCommandOpenBrush", "#5CC8FF");
            SetBrush(resources, "AppCommandPreviewBrush", "#C6A7FF");
            SetBrush(resources, "AppCommandFavoriteBrush", "#FFD166");
            SetBrush(resources, "AppCommandSaveBrush", "#7DDB8C");
            ...
            SetBrush(resources, "AppScrollBarTrackBrush", "#15191C");
            SetBrush(resources, "AppScrollBarThumbBrush", "#65717B");
            SetBrush(resources, "AppScrollBarThumbHoverBrush", "#A0ABB4");
            SetBrush(resources, "AppScrollBarThumbBorderBrush", "#7B8790");
            ...
            SetBrush(resources, SystemColors.ScrollBarBrushKey, "#15191C");
        ...
        SetBrush(resources, "AppResultsBrush", "#F5F7F9");
        SetBrush(resources, "AppSearchInputBrush", "#FFFFFF");
        SetBrush(resources, "AppSearchInputBorderBrush", "#8A8A8A");
        ...
        SetBrush(resources, "AppCommandOpenBrush", "#0078D4");
        SetBrush(resources, "AppCommandPreviewBrush", "#7356BF");
        SetBrush(resources, "AppCommandFavoriteBrush", "#C78A00");
        SetBrush(resources, "AppCommandSaveBrush", "#107C10");
        ...
        SetBrush(resources, "AppScrollBarTrackBrush", "#E4E9ED");
        SetBrush(resources, "AppScrollBarThumbBrush", "#64707B");
        SetBrush(resources, "AppScrollBarThumbHoverBrush", "#3E4B55");
        SetBrush(resources, "AppScrollBarThumbBorderBrush", "#53606A");
        ...
        SetBrush(resources, SystemColors.ScrollBarBrushKey, "#E4E9ED");
